...
(function () {
  emailjs.init({
    publicKey: "Zn_9ju5wWQMQBpJt1",
  });
})();

  // Validate and submit form via EmailJS
  document
    ...
    const message = document.getElementById("contactMessage").value.trim();
      ...
      var sLoader = document.getElementById("submit-loader");
      sLoader.style.display = "block"; // Show loader
      ...
      emailjs
        .send("service_atelhmi", "MohamedCodes", {
          contact_name: name,
          contact_email: email,
